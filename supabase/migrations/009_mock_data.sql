...
BEGIN
  ...
  INSERT INTO public.restaurants (
    ...
    (pizza_rest_uuid,  loc_campus_uuid, 'Pizza Palace', 'Italian',  '(123) 456-7890', true,  true,  'ubereats_pizza_palace_123', 'ubereats', '1325 Sunnyvale Saratoga Rd, Sunnyvale, CA 94087', 'https://example.com/pizza_palace.jpg', 4.5, 2.99, 15.00, true, ARRAY['grubhub','ubereats','doordash'],jsonb_build_object('grubhub',  'gh_pizza_palace_123', 'ubereats', 'ubereats_pizza_palace_123', 'doordash', 'dd_pizza_palace_123')),
    (burger_rest_uuid, loc_office_uuid, 'Burger Joint', 'American', '(987) 654-3210', false, false, 'ubereats_burger_joint_456', 'ubereats', '2310 Homestead Rd, Los Altos, CA 94024', 'https://example.com/burger_joint.jpg',  4.2, 1.99, 10.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (taco_rest_uuid,  loc_campus_uuid,    'Taqueria El Sol',      'Mexican',      '(408) 555-1201', false, true,  'ubereats_taqueria_el_sol_001',  'ubereats', '1111 El Camino Real, Santa Clara, CA 95050',     'https://example.com/taqueria.jpg',   4.4, 2.49, 10.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (sushi_rest_uuid, loc_office_uuid,    'Sushi Kai',            'Japanese',     '(650) 555-2202', false, false, 'ubereats_sushi_kai_001',         'ubereats', '250 Castro St, Mountain View, CA 94041',         'https://example.com/sushi.jpg',      4.7, 4.99, 15.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (thai_rest_uuid,  loc_hotel_uuid,     'Thai Spice Kitchen',   'Thai',         '(408) 555-3303', false, true,  'ubereats_thai_spice_kitchen_001','ubereats', '1020 N Mathilda Ave, Sunnyvale, CA 94089',        'https://example.com/thai.jpg',       4.5, 3.49, 12.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (med_rest_uuid,   loc_sanmarcos_uuid, 'Mediterranean Grill',  'Mediterranean','(669) 555-4404', false, true,  'ubereats_mediterranean_grill_001','ubereats','20688 Stevens Creek Blvd, Cupertino, CA 95014',  'https://example.com/med.jpg',        4.6, 2.99, 12.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (salad_rest_uuid, loc_campus_uuid,    'Green Leaf Salads',    'Healthy',      '(408) 555-5505', false, false, 'ubereats_green_leaf_salads_001', 'ubereats', '650 W El Camino Real, Sunnyvale, CA 94087',       'https://example.com/salads.jpg',     4.3, 1.99,  8.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (bagel_rest_uuid, loc_office_uuid,    'Bagel Barn & Deli',    'Breakfast',    '(650) 555-6606', false, false, 'ubereats_bagel_barn_001',        'ubereats', '4546 El Camino Real, Los Altos, CA 94022',        'https://example.com/bagels.jpg',     4.1, 0.00,  0.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (bbq_rest_uuid,   loc_hotel_uuid,     'Smokehouse BBQ',       'BBQ',          '(408) 555-7707', false, true,  'ubereats_smokehouse_bbq_001',    'ubereats', '1001 S Wolfe Rd, Sunnyvale, CA 94086',            'https://example.com/bbq.jpg',        4.2, 3.99, 20.00, true, ARRAY['grubhub'], '{}'::jsonb),
    (vegan_rest_uuid, loc_sanmarcos_uuid, 'Plant Kitchen',        'Vegan',        '(669) 555-8808', true,  false, 'ubereats_plant_kitchen_001',     'ubereats', '1275 W El Camino Real, Sunnyvale, CA 94087',      'https://example.com/vegan.jpg',      4.8, 2.49, 10.00, true, ARRAY['grubhub'], '{}'::jsonb);
